...
import WebhooksList from '../components/settings/api/WebhooksList';
            ...
            <div className="max-w-full mx-auto w-full py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-8">
                <nav className="flex items-center space-x-3 text-sm">
                  ...
                  <span className="text-gray-900 dark:text-white font-medium">Webhooks</span>
                </nav>
              </div>
              ...
              <div className="bg-white dark:bg-dark-800 rounded-lg shadow-sm border border-gray-200/50 dark:border-dark-700/50 overflow-hidden">
                ...
                <div className="p-6 sm:p-8 border-b border-gray-200 dark:border-dark-700">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-pink-600 to-gray-900 dark:from-white dark:via-pink-400 dark:to-white">Webhooks</h1>

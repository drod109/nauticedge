-- Create user_mfa table if it doesn't exist
...
DROP POLICY IF EXISTS "Users can view their own verification attempts" ON mfa_verification_attempts;
DROP POLICY IF EXISTS "Users can manage their temporary MFA setup" ON mfa_temp;
